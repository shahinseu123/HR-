    ...
    export default {
        ...
        methods: {
           getLeaveReqForAdmin(){
            ...
            approve(id){
                axios.put('/api/approvebysuperadmin/'+id)
                     .then(() => {
            ...
            discured(id){
                axios.put('/api/discurdbysuperadmin/'+id)
                     .then(() => {
                          this.$router.push('/discurded-req-for-super-admin')
            ...
            gotohome(){
                this.$router.push('/pending-req-for-super-admin')
            },
