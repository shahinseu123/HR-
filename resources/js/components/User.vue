<template>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="card" v-show="$gate.isAdmin()">
            ...
            <form @submit.prevent="editMode ? editUser() : createUser()">
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input v-model="form.empid" type="text" name="empid" placeholder="Enter ID"
               ...
               this.form.delete('api/user/'+id)
                  ...
                  .catch(() => {
                      ...
                      swal.fire({
                                    ...
                                    footer: '<a href>Are you authorize to delete someone?</a>'
                                    })
                             })
