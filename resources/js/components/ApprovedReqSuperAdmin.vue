                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="leave in getleaveapprovesuper" :key="leave.id">
                                        <td>{{leave.empname}}</td>
...
<script>
    export default {
        data(){
          return {
            getleaveapprovesuper: {}
          }
        
        },
        methods: {
           getapproveleavesuper(){
               axios.get('api/createleaveapproveforsuper')
                    .then(({data}) => {
                        this.getleaveapprovesuper = data
                    })
                    .catch((error) =>{
                        console.log(error)
                    })
