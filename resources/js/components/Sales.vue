              ...
              <div class="card">
                 <div class="card-header">
                  ...
                  <div class="card-body table-responsive">
                    ...
                    <tbody>
                    <tr v-for="stuff in sales.data" :key="stuff.id">
                        <td>{{stuff.idno}}</td>
                        <td>{{stuff.name}}</td>
                        <td>{{stuff.email}}</td>
                        ...
                        <td>
                            <!-- edit  -->
                            <a href="#" @click="editSales(stuff)"  ><i class="fas fa-edit green"></i></a><span> /  </span><a href="#" @click="deleteSales(stuff.id)"><i class="fas fa-trash-alt red"></i></a>
                            <!-- edit  -->
                        </td>
		...
		// },
            ...
            loadSales(){
              ...
              axios.get('api/sale')
                    .then(({data})=>{
                     this.sales = data 
                     this.saleslength = data.data.length
                     Bus.$emit('eventbus', this.saleslength)
                     }).catch(() => {
