    ...
    <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center teal">Discurded Leave Requests</h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="leave in leaveRequests" :key="leave.id">
                                        ...
                                        <td v-show="leave.isapprovedbysuperadmin == null"><span class="badge label label-warning">{{leave.isapprovedbysuperadmin|approvedbysuperadmin}}</span></td>
                                        <td> 
...
<script>
    export default {
        ...
        methods: {
           getrejectleavesuper(){
               axios.get('api/createleaverejectforsuper')
                    .then(({data}) => {
